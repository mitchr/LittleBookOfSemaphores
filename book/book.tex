...
\usepackage{tocloft}
\usepackage{sectsty}
\usepackage[paperheight=6.875in, paperwidth=4.25in]{geometry}
...
% prevent lstlistings from being affected by page breaks
\lstnewenvironment{unbreakable}[1][]
...
% format hints so that each one starts on the left page
...
%\begin{unbreakable}[title={Party problem hint}]{}
%\end{unbreakable}

%
%\subsection {Party problem solution}

%\begin{unbreakable}[title={Party problem solution}]{}
%\end{unbreakable}
